...
function TopLayout() {
    ...
    const { currentPage, setCurrentPage } = useContext(TokenContext);
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.buttonsContainer}>
                <button 
                    style={{...styles.button, ...(currentPage === 'main' ? styles.activeButton : {})}}
                    onClick={() => navigateToPage('main')}
                >
                    Products
                </button>
                <button 
                    style={{...styles.button, ...(currentPage === 'order' ? styles.activeButton : {})}}
                    onClick={() => navigateToPage('order')}
                >
                    Order
                </button>
                <button 
                    style={{...styles.button, ...(currentPage === 'blackbook' ? styles.activeButton : {})}}
                    onClick={() => navigateToPage('blackbook')}
                >
                    Blackbook
                </button>
